...
-- Enable UUID extension if needed (optional, keeping VARCHAR(27) for compatibility)
...
CREATE TABLE products (
  ...
  badge VARCHAR(50) NULL, -- new, bestseller, promo, etc.
  ...
  format VARCHAR(50) NULL, -- Broché, Relié, Poche
  dimensions VARCHAR(100) NULL,
  "publicationDate" TIMESTAMP NULL,
  
  -- Perfume-specific fields
  volume VARCHAR(50) NULL, -- 50ml, 100ml
  ...
  year INTEGER NULL,
  specifications TEXT NULL, -- JSON object for flexible specs
